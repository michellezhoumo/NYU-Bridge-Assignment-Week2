...
int main() {
    ...
    cin >> numberOfQuarters >> numberOfDimes >> numberOfNickels >> numberOfPennies;
    ...
    cout << "# of quarters: " << numberOfQuarters << endl;
    cout << "# of dimes: " << numberOfDimes << endl;
    cout << "# of nickels: " << numberOfNickels << endl;
    cout << "# of pennies: " << numberOfPennies << endl;
